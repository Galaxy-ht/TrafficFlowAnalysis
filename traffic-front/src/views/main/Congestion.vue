...
const value = ref('')
let star1 = (Math.random() * 100).toFixed(2)
let star2 = (Math.random() * 100).toFixed(2)
let star3 = (Math.random() * 100).toFixed(2)
let star4 = (Math.random() * 100).toFixed(2)
let star5 = (Math.random() * 100).toFixed(2)
let star6 = (Math.random() * 100).toFixed(2)
let data = [
  { name: "武进区", value: 87.4, star: star1, location: [119.942, 31.700] },
  { name: "新北区", value: 42.4, star: star2, location: [119.955, 31.864] },
  { name: "钟楼区", value: 76.9, star: star3, location: [119.901, 31.802] },
  { name: "天宁区", value: 45.2, star: star4, location: [119.994, 31.793] },
  { name: "金坛区", value: 23.7, star: star5, location: [119.582, 31.723] },
  { name: "溧阳市", value: 41.6, star: star6, location: [119.483, 31.415] },
]
onMounted(() => {
...
const loadRoad = async () => {
  ...
  data = res.data.list.map(item => ({
    ...
    star: parseFloat((Math.random() * 100).toFixed(2)),
        ...
        tooltip: {
          formatter: function (params, ticket, callback) {
            if (params.value[2] <= 0) {
              ...
              return params.name + "拥堵指数： " + params.value[2] + "<br />五分钟后预计：" + params.data.star
            }
          }
        },
        itemStyle: {
